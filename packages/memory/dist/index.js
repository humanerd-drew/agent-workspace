...
const server = new Server({ name: "agent-memory", version: "0.1.0" }, { capabilities: { tools: {} } });
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        {
            name: "remember",
            description: "Store a fact, decision, pattern, or incident into persistent memory for cross-session recall",
            inputSchema: {
                type: "object",
                properties: {
                    fact: {
                        type: "string",
                        description: "The content to remember — should be a complete, self-contained statement",
                    },
                    type: {
                        type: "string",
        ...
        {
            name: "recall",
            description: "Search persistent memory across all past sessions using full-text search. Returns most relevant entries first.",
            inputSchema: {
                type: "object",
                properties: {
                    query: {
                        type: "string",
                        description: "Search query. Empty string returns most recent entries.",
                    },
                    limit: {
                        type: "number",
        ...
        {
            name: "forget",
            description: "Delete a memory entry by its ID. Returns whether the deletion was successful.",
            inputSchema: {
                type: "object",
                properties: {
                    id: {
        ...
        {
            name: "update",
            description: "Update a memory entry's fact and/or type by ID. Returns the updated entry.",
            inputSchema: {
                type: "object",
                properties: {
                    id: {
        ...
        {
            name: "memory-stats",
            description: "Show memory database statistics: total entries, breakdown by type, database size",
            inputSchema: {
                type: "object",
                properties: {},
            },
